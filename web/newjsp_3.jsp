    ...
    <body>
        ...
        <div id="section-to-print" class="page" style="border:0px red solid;">
            ...
            <div id="flex_1" style="border:0px red solid;position: absolute;top:6%;left:0%;width:100%;height: 90%;">
                ...
                <input type="text" id="input_g_1" autocomplete="off" style="width:20%;height:30px;float:right;right:780px;top:1px;position:absolute;
                       text-align:center;border:0px black solid;font-weight: bolder;font-size:16pt;"/>
                <input type="text" id="input_customer_name" autocomplete="off" style="width:68%;height:60px;float:right;right:2px;top:1px;position:absolute;
                       text-align:center;border:0px black solid;font-size:38pt;"/>
                ...
                <input type="text" id="input_item_number" autocomplete="off" style="width:30%;height:30px;float:right;right:2px;top:60px;position:absolute;
                       text-align:center;border:1px black solid; border-bottom: 1px #cccccc solid;font-weight: bolder;font-size:16pt;"/>
                ...
                <input type="text" id="input_po_number" autocomplete="off" style="width:30%;height:30px;float:right;right:2px;top:90px;position:absolute;
                       text-align:center;border:1px black solid; border-top: 1px #cccccc solid;font-weight: bolder;font-size:16pt;"/>
                ...
                <label id="label_size" for="input_material" style="font-size:11pt;float:right;right:210px;top:155px;position:absolute;"> MATERIAL </label>
                ...
                <div id="select_no_name_1" class="select" style="float:right;right:580px;top:520px; width: 20%;position:absolute; ">
                    <select style="color:black;font-weight:bolder;height:30px;border:none;">
                        <option value="" selected></option>
                        <option>TEXT</option>
                ...
                <div id="select_no_name_2" class="select" style="float:right;right:353px;top:618px; width: 50%;position:absolute; ">
                    <select style="color:black;font-weight:bolder;height:30px;border:none;">
                        <option value="" selected></option>
                        <option>DSP PLATES - 2400 PPI</option>
         ...
         <textarea id="textarea_note" autocomplete="off" rows="10" cols="50" style="
                ...
                <input type="text" id="input_art" autocomplete="off" style="width:22%;height:60px;float:right;right:2px;top:730px;position:absolute;
                       text-align:center;border:1px black solid;font-size:38pt;border:none;"/>
        ...
        <div id="section-to-print_2" class="page" style="margin-top: 1%; border: 0px red solid;">
            ...
            <div id="flex_2" style="border:0px red solid;position: absolute;top:6%;left:0%;width:100%;height: 90%;">
                ...
                <label id="label_eyespot_color" for="input_eyespot_color" style="font-size:11pt;float:right;right:238px;top:830px;position:absolute;font-weight:bold;"> EYESPOT COLOUR </label>
                ...
                <label id="label_guideline_color" for="input_guideline_color" style="font-size:11pt;float:right;right:238px;top:861px;position:absolute;font-weight:bold;"> GUIDELINE COLOUR </label>
                ...
                <input type="text" id="input_remark_2" autocomplete="off" style="width:99.5%;height:30px;float:right;right:3px;top:1019px;position:absolute;
                       text-align:left;border:1px black solid;border-top:none;font-weight: bolder;font-size:16pt;"/>
            ...
            <div id="box_mounting_title" style="position: absolute;right:38px;top:1px;background-color:rgba(192,192,192,0.3); width:90%;height:100px; 
                ...
                <%-- 四个方框上面的输入框 --%>
                <input type="text" id="mount_across_top_a" autocomplete="off" style="position:absolute;top:670px;left:38px;
                       border:0px black solid;width:68px;height:30px;text-align:center;" />
                <input type="text" id="mount_across_top_b" autocomplete="off" style="position:absolute;top:670px;left:158px;
                       border:0px black solid;width:68px;height:30px;text-align:center;" />
                <input type="text" id="mount_across_top_c" autocomplete="off" style="position:absolute;top:670px;left:277px;
                       border:0px black solid;width:68px;height:30px;text-align:center;" />
                <input type="text" id="mount_across_top_d" autocomplete="off" style="position:absolute;top:670px;left:397px;
                       border:0px black solid;width:68px;height:30px;text-align:center;" />
                <input type="text" id="mount_across_top_e" autocomplete="off" style="position:absolute;top:670px;left:516px;
                       border:0px black solid;width:68px;height:30px;text-align:center;" />
                <input type="text" id="mount_across_top_f" autocomplete="off" style="position:absolute;top:670px;left:636px;
                       border:0px black solid;width:68px;height:30px;text-align:center;" />
                <input type="text" id="mount_across_top_g" autocomplete="off" style="position:absolute;top:670px;left:756px;
                       border:0px black solid;width:68px;height:30px;text-align:center;" />
                <input type="text" id="mount_across_top_h" autocomplete="off" style="position:absolute;top:670px;left:876px;
                       border:0px black solid;width:68px;height:30px;text-align:center;" />
