 ...
 * @author w15rdknl
 */
public class data_set_2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // http parameters 
        String[] p_1 = request.getParameterValues("all_Element_page2[]");
        ...
        String sql_stmt = "IF NOT EXISTS (SELECT * FROM [proms].[dbo].[data_table_2] WHERE " + p_sn + " = '" + p_sn_val + "')\n"
                + " INSERT INTO [proms].[dbo].[data_table_2] (" + p_sn + "," + sql_stmt_insert_tmp_1 +") VALUES ('" + p_sn_val +"'," +  sql_stmt_insert_tmp_2 +")\n"
                + " ELSE\n"
                + " UPDATE [proms].[dbo].[data_table_2] SET " + sql_stmt_update_tmp_3 + " WHERE " + p_sn + " = '"+ p_sn_val + "'";               
        ...
        try {
            ...
            j_data_set_2 = "false";
            System.out.println("error modifying page 2 data: " + e.getMessage());
        } finally {
            try {
                ...
                myjsonobj.put("j_data_set_2", j_data_set_2);
