 ...
 * @author w15rdknl
 */
public class data_get_1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // http parameters 
        //String[] p_1 = request.getParameterValues("all_Element_page1[]");
        ...
        String j_data_get_1 = "true";

        JSONArray myarray12 = new JSONArray();

        // String sql_stmt = "SELECT * FROM [proms].[dbo].[data_table_1] WHERE " + p_sn + " = '" + p_sn_val + "'";
        try {
            ps = connection.prepareStatement("SELECT * FROM [proms].[dbo].[data_table_1] WHERE page1_sn = ?");
                ...
                while (rs.next()) {
                    ...
                    for (int i = 1; i <= rsmd.getColumnCount(); i++) {
                        ...
                        switch (rsmd.getColumnName(i)) {
                            case "page1_note":
                                myjsonobj.put("Name", rsmd.getColumnName(i).replace(rsmd.getColumnName(i).substring(0, rsmd.getColumnName(i).indexOf("_")), "textarea"));
        ...
        String sql_stmt = "IF NOT EXISTS (SELECT * FROM [proms].[dbo].[data_table_1] WHERE " + p_sn + " = '" + p_sn_val + "')\n"
                + " INSERT INTO [proms].[dbo].[data_table_1] (" + p_sn + "," + sql_stmt_insert_tmp_1 +") VALUES ('" + p_sn_val +"'," +  sql_stmt_insert_tmp_2 +")\n"
                + " ELSE\n"
                + " UPDATE [proms].[dbo].[data_table_1] SET " + sql_stmt_update_tmp_3 + " WHERE " + p_sn + " = '"+ p_sn_val + "'";               
        ...
        try {
            ...
            System.out.println(e.getMessage());
            j_data_set_1 = "false";
            System.out.println("error modifying page 1 data: " + e.getMessage());
        } finally {
            try {
                ...
                JSONObject myjsonobj = new JSONObject();
                myjsonobj.put("j_data_set_1", j_data_set_1);
                myarray.put(myjsonobj);
            } catch (SQLException | JSONException e) {
                System.out.println(e.getMessage());
            }
